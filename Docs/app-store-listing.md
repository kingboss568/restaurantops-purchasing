# App Store Listing Draft (Submission-Level)
...
掌握行情、看穿報價、直接談出更好的採購條件。免費下載，PRO 解鎖完整採購戰情。

## Description

餐採智控是為台灣餐廳打造的採購決策工具。你可以建立食材與供應商資料、同步市場行情、比較多家報價、產生可直接傳給供應商的議價訊息。
...
- 匯入或快取農產品與批發行情
- 記錄多家供應商報價
- 自動比較供應商報價與 7 日 / 30 日市場均價
- 顯示供應商價格排名與價差百分比
- 產生可貼到 LINE 或訊息的議價草稿
- PRO 進階：建議目標價、年化節省預估、採購風險分數、談判槓桿建議
- 無網路時仍可查看最近一次行情快取

餐採智控的所有價差、均價與排名都由 App 內的 deterministic service 計算。AI 只協助整理與改寫議價文字，不會自行產生或修改價格數字。
...
- 提供進階採購戰情（目標價、年化節省、風險評分、談判策略）

## Keywords

餐廳,採購,進貨,食材,比價,議價,供應商,行情,成本,餐飲管理
...
上架版：實接行情 API、多供應商比價、AI 議價助手、PRO 進階採購戰情。
